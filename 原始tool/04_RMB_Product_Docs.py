...
def get_page_views_7(client, area):
    kusto_query_7 = open(path_mbr.query_path_product_7,'r').read().format(area)
...
#     kusto_query_11 = "database('DevRelWorkArea').['kpi-azure-impact'] " \
#                     "| where Area == '" + area + "' " \
...
for i in range(14):
    ...
    sheet_x.cell(x + 2, y, current_1.iloc[i][j + 1]) #11行
    sheet_x.cell(x + 3, y, current_2.iloc[i][j + 1]) #12行
    sheet_x.cell(x + 4, y, current_3.iloc[i][j + 1]) #13行
    sheet_x.cell(x + 5, y, current_4.iloc[i][j + 1]) #14行
    sheet_x.cell(x + 6, y, current_5.iloc[i][j + 1]) #15行
    sheet_x.cell(x + 7, y, current_6.iloc[i][j + 1]) #16
    sheet_x.cell(x + 9, y, current_7.iloc[i][j + 1]) #18
    sheet_x.cell(x + 10, y, current_8.iloc[i][j + 1]) #19
    sheet_x.cell(x + 11, y, current_9.iloc[i][j + 1]) #20
    sheet_x.cell(x + 13, y, current_10.iloc[i][j + 1]) #20
    y += -1
    i += 1
